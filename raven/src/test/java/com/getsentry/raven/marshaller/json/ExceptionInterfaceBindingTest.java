...
public class ExceptionInterfaceBindingTest {
    ...
    public void testSimpleException() throws Exception {
        ...
        assertThat(jsonGeneratorParser.value(), is(jsonResource("/com/getsentry/raven/marshaller/json/Exception1.json")));
    }
    ...
    public void testClassInDefaultPackage() throws Exception {
        ...
        assertThat(jsonGeneratorParser.value(), is(jsonResource("/com/getsentry/raven/marshaller/json/Exception2.json")));
    }
    ...
    public void testChainedException() throws Exception {
        ...
        assertThat(jsonGeneratorParser.value(), is(jsonResource("/com/getsentry/raven/marshaller/json/Exception3.json")));
    }
