...
import static com.getsentry.raven.marshaller.json.JsonComparisonUtil.jsonResource;
import static com.getsentry.raven.marshaller.json.JsonComparisonUtil.newJsonGenerator;
...
public class UserInterfaceBindingTest {
    ...
    public void testSimpleMessage() throws Exception {
        ...
        assertThat(jsonGeneratorParser.value(), is(jsonResource("/com/getsentry/raven/marshaller/json/User1.json")));
    }
}
